...
continue_text = font.render("Click anywhere to play again", True, RED, DARKGREEN)
...
# Set images (use simple rects in this case)
# For a rectangles you need (top-left x, top-left y, width, height)
...
while running:
    ...
    # This will essentialy move all of the snakes body by one position in the list
    body_coords.insert(0, head_coord)
    body_coords.pop()

    # Update x,y posotion of the snakes head and make a new coordinate
    head_x += snake_dx
    head_y += snake_dy
    head_coord = (head_x, head_y, SNAKE_SIZE, SNAKE_SIZE)
    ...
    if head_rect.left < 0 \
        ...
        # pause the game untile the player presses a kea, then reset the game
        is_paused = True
        while is_paused:
            for event in pygame.event.get():
